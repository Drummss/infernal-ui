  ...
  themes: {
    volcanic: createAccentTheme({
      ...
      colors: {
        palette: {
          text: {
            DEFAULT: { base: '{colors.slate.900}', _dark: '{colors.slate.100}' },
            muted: { base: '{colors.slate.700}', _dark: '{colors.slate.300}' },
            subtle: { base: '{colors.slate.600}', _dark: '{colors.slate.400}' },
          },
          background: {
            DEFAULT: { base: '{colors.slate.50}', _dark: '{colors.slate.950}' },
          ...
          border: {
            ...
            emphasized: { base: '{colors.orange.500}', _dark: '{colors.violet.500}' },
          },
        },
        typography: {
          color: {
